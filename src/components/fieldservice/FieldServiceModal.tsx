    ...
    <>
      {!open && (
        <Button
          ...
          className="fixed bottom-20 right-4 z-[999999] h-14 w-14 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-200 hover:scale-110 active:scale-95 touch-manipulation md:bottom-6 md:right-6"
