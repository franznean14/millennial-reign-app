...
export function AppChrome({ children }: AppChromeProps) {
  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-border/70 bg-background/80 backdrop-blur lg:hidden pb-[max(env(safe-area-inset-bottom),0.1rem)]">
