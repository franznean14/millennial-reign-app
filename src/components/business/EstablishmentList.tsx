...
export function EstablishmentList({ establishments, onEstablishmentClick }: EstablishmentListProps) {
    ...
    <div className="grid gap-4 mt-6 w-full">
      {establishments.map((establishment, index) => (
        ...
        >
          <Card 
            className={cn(
              "cursor-pointer hover:shadow-md transition-all duration-300 hover:scale-[1.02] w-full",
